			...
			<td colspan="2" valign="top" align="left"><img src="<cms:link>/images/spacer.gif</cms:link>" alt="" height="1" border="0" /> <br />
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<% while (blog.hasMoreBlogs()) { %>
						<tr>
							<td width="100%" class="blogHeadline"><%=blog.linkToCurrentItem(blog.getField("Title"))%><cms:editable mode="manual" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="bodyText" valign="top">
								<div class="photo">
									...
									<%=BlogJspTemplate.trimUp(blog.getField("BlogText"), 700)%>&nbsp;
